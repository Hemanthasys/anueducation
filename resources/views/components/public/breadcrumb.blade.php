{{--
    ...
    Usage: @include('components.public.breadcrumb', [
        'items' => [
            ['label' => __('news'), 'url' => route('news.index')],
            ['label' => $news->title, 'url' => null],
        ]
    ])
    Home is always automatic. Last item = current page (no url). Previous items = links.
--}}
<nav style="background: var(--color-primary); border-bottom: 1px solid rgba(255,255,255,0.1);"
